...
function createUnimport(opts) {
  ...
  async function scanImportsFromDir(dirs = ctx.options.dirs || [], options = ctx.options.dirsScanOptions) {
    ...
    await modifyDynamicImports((imports2) => imports2.filter((i) => !files.includes(i.from)).concat(deduped));
    return imports;
  }
...
export { resolveBuiltinPresets as a, builtinPresets as b, scanDirExports as c, dedupeDtsExports as d, scanExports as e, createUnimport as f, resolvePreset as r, scanFilesFromDir as s, version as v };
